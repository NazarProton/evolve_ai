...
const VoiceInput: React.FC<VoiceInputProps> = ({
  ...
  return (
    <div className="relative flex w-full flex-col items-center font-chivo-mono-light uppercase">
      ...
      <button
        onClick={handleClick}
        className="relative group flex items-center justify-center h-[48px] w-[48px] transition-opacity duration-300"
      >
        ...
        <img
          ...
          className="w-12 h-12 opacity-25 transition-opacity duration-300 ease-out group-hover:opacity-100"
        />
      </button>
    </div>
  );
